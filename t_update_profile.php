...
if (isset($_SESSION['teacher_username'])) {
    ...
    $query = "SELECT * FROM teacher WHERE teacher_username = '$teacher_username'";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $update_query = "UPDATE teacher SET name='$name', email='$email', phone='$phone'";
...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        <!-- Topbar header -->
        <?php include 'components/t_topbar.php'; ?>
        <!-- End Topbar header -->

        <!-- Left Sidebar -->
        <?php include 'components/t_sidebar.php'; ?>
        <!-- End Left Sidebar -->
                    ...
                    <div class="form-group col-md-6 text-center">
                        <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                <div id="imagePreview" style="background-image: url(<?php echo $teacher_image; ?>);"></div>
                                <label for="username" class="mt-3"><?php echo $user_details['teacher_username']; ?></label>
                            </div>
                        </div>
                    </div>
