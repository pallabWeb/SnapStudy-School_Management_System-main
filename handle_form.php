...
?>
        ...
        <body>
            <div class="container mt-5">
                <h2 class="text-center">Add Payment for Student</h2>
                        ...
                        <div class="content">
                            ...
                            <form action="process_yearly_payment.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="yearly_fees_amount" id="yearly_fees_amount" value="<?= $total_yearly_fees ?>">
                                </div>
                                <div class="form-group">
                                    <label for="library_fees_amount">Library Fees Amount:</label>
                                    <input type="text" class="form-control" name="library_fees_amount" id="library_fees_amount" value="15000" required>
                                </div>
                                <div class="form-group">
                                    <label for="tuition_fees_amount">Tuition Fees Amount:</label>
                                    <input type="text" class="form-control" name="tuition_fees_amount" id="tuition_fees_amount" value="30000" required>
                                </div>
                                <div class="form-group">
                                    <label for="development_fees_amount">Development Fees Amount:</label>
                                    <input type="text" class="form-control" name="development_fees_amount" id="development_fees_amount" value="20000" required>
                                </div>
                                <div class="form-group">
                                    <label for="extra_fees_amount">Extra Fees Amount:</label>
                                    <input type="text" class="form-control" name="extra_fees_amount" id="extra_fees_amount" value="15000" required>
                                </div>
                                <div class="form-group">
                                    <label for="transaction_mode">Transaction Mode:</label>
                                    <select class="form-control" name="transaction_mode" id="transaction_mode" required onchange="toggleTransactionId()">
                                        <option value="cash">Cash</option>
                                        <option value="online">Online</option>
                                    </select>
                                </div>
                                <div class="form-group" id="payment_id_group" style="display: none;">
                                    <label for="payment_id">Transaction ID:</label>
                                    <input type="text" class="form-control" maxlength="10" name="payment_id" id="payment_id">
                                </div>
                        ...
                        <div class="content">
                            ...
                            <form action="process_after_6_months_payment.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="after_6_months_fees_amount" id="after_6_months_fees_amount" value="<?= $current_payment_amount ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cycle">Payment For:</label>
                                    <select class="form-control" id="cycle" name="cycle" required>
                                        <option value="1st 6 Months">1st 6 Months</option>
                                        <option value="2nd 6 Months">2nd 6 Months</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="library_fees_amount">Library Fees Amount:</label>
                                    <input type="text" class="form-control" name="library_fees_amount" id="library_fees_amount" value="8000" required>
                                </div>
                                <div class="form-group">
                                    <label for="tuition_fees_amount">Tuition Fees Amount:</label>
                                    <input type="text" class="form-control" name="tuition_fees_amount" id="tuition_fees_amount" value="16000" required>
                                </div>
                                <div class="form-group">
                                    <label for="development_fees_amount">Development Fees Amount:</label>
                                    <input type="text" class="form-control" name="development_fees_amount" id="development_fees_amount" value="10000" required>
                                </div>
                                <div class="form-group">
                                    <label for="extra_fees_amount">Extra Fees Amount:</label>
                                    <input type="text" class="form-control" name="extra_fees_amount" id="extra_fees_amount" value="6000" required>
                                </div>
                                <div class="form-group">
                                    <label for="transaction_mode">Transaction Mode:</label>
                                    <select class="form-control" name="transaction_mode" id="transaction_mode" required onchange="toggleTransactionId()">
                ...
                <div class="board left">
                    <h3 class="text-center mb-4">Total Yearly Fees</h3>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <p class="card-text">Total Fees: ₹80,000</p>
                                    <p class="card-text">Development Fees: ₹20,000</p>
                                    <p class="card-text">Library Fees: ₹15,000</p>
                                    <p class="card-text">Tuition Fees: ₹30,000</p>
                                    <p class="card-text">Extra Fees: ₹15,000</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="board right">
                    <h3 class="text-center mb-4">Total 6-Month Fees</h3>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <p class="card-text">Total Fees: ₹40,000</p>
                                    <p class="card-text">Development Fees: ₹10,000</p>
                                    <p class="card-text">Library Fees: ₹8000</p>
                                    <p class="card-text">Tuition Fees: ₹16,000</p>
                                    <p class="card-text">Extra Fees: ₹6000</p>
                ...
                <div class="text-center back-button mt-5">
            ...
            <script>
                function toggleTransactionId() {
                    ...
                    var paymentIdGroup = document.getElementById('payment_id_group');
                    if (transactionMode === 'online') {
                        paymentIdGroup.style.display = 'block';
                    } else {
                        paymentIdGroup.style.display = 'none';
                    }
                }
            </script>
