    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Toast Notification -->
                <div class="toast align-items-center text-white bg-success-light" role="alert" aria-live="assertive" aria-atomic="true" id="successToast" style="position: fixed; top: 20px; left: 50%; transform: translateX(-50%); z-index: 9999;">
                    <div class="d-flex">
                ...
                <form class="row g-3" id="addTeacherForm">
                    <div class="col-md-6">
                        <label for="username" class="mt-3">Username:</label>
                        <input type="text" class="form-control" name="teacher_username" id="username" placeholder="Enter your username" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" rows="3" name="description" placeholder="Text Here..."></textarea>
                    </div>

                    <div class="col-12">
                        <button type="submit" class="btn btn-success mt-3 rounded-3 float-end submit" name="add_student">Add Teacher</button>
                    </div>
                </form>
    ...
    <script>
        $(document).ready(function() {
            $("#addTeacherForm").submit(function(event) {
                ...
                $.ajax({
                    url: "add-teacher.php", // Change to your actual PHP file URL
                    type: "POST",
                    data: formData,
                    success: function(response) {
                        if (response.trim() === "error") {
                            // Show error toast notification if user already exists
                            $(".toast").removeClass("bg-success").addClass("bg-danger").find(".toast-body").text("Teacher already exists!");
                            $(".toast").toast('show');
                        } else if (response.trim() === "success") {
                            // Show success toast notification if student added successfully
                            $(".toast").removeClass("bg-danger").addClass("bg-success").find(".toast-body").text("Teacher added successfully!");
                            $(".toast").toast('show');
                        } else {
                            console.error("Unexpected response from server: " + response);
                        }
                        $("#addTeacherForm")[0].reset(); // Clear form fields
                    },
