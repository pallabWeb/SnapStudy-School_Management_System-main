            ...
            <ul class="navbar-nav float-end">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo $user_details['image']; ?>" class="rounded-circle" height="40" width="40" alt="profile_image">
                        <span class="ms-2 d-none d-lg-inline-block"><span>Hello,</span> <span class="text-dark"><?php echo $_SESSION['student_username']; ?></span> <i data-feather="chevron-down" class="svg-icon"></i></span>
                    </a>
