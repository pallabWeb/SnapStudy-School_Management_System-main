...
$sql = "SELECT id, teacher_username, email, phone, name, class, description, image FROM teacher";
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    ...
                    <h1 class="white-text">Our Experienced Teachers</h1>
        ...
        <div class="container">
            <div class="row">
                ...
                foreach ($teachers as $teacher) :
                    ...
                    $imagePath = !empty($teacher['image']) ? '../' . $teacher['image'] : 'img/avater.jpg';
                ?>
                    <div class="col-lg-3 col-md-6">
                        <div class="team-member">
                            <div class="main-content">
                                <img src="<?php echo $imagePath; ?>" alt="<?php echo $teacher['name']; ?>">
